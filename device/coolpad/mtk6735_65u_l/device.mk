...
include device/coolpad/$(MTK_TARGET_PROJECT)/ProjectConfig.mk
include device/coolpad/$(MTK_TARGET_PROJECT)/ProjectConfig_ckt.mk
...
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/coolpad/mtk6735_65u_l/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/thermal_eng.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/thermal.conf:system/etc/.tp/thermal.conf
endif
...
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/coolpad/mtk6735_65u_l/audio_policy.conf:system/etc/audio_policy.conf
...
DEVICE_PACKAGE_OVERLAYS += device/coolpad/mtk6735_65u_l/overlay
